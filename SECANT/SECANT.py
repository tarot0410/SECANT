...
def SECANT_CITE(data0, numCluster, K, cls_np, uncertain = True, learning_rate=0.01, nIter=100, init_seed=2020, device=device):
...
# Final function to run algorithm for one dataset case
def SECANT_joint(data0, data1, numCluster, K, cls_np, uncertain = True, learning_rate=0.01, nIter=100, init_seed=2020, device=device):
    torch.manual_seed(init_seed)
